...
var formatRgb = function formatRgb(decimalObject, parameterA) {
  ...
  //public static let myColor:Color = Color(UIColor(red:#/255, green:#/255, blue:#/255, alpha:1))';
  return "public static let myColor:Color = Color(UIColor(red:".concat(r, "/255, green:").concat(g, "/255, blue:").concat(b, "/255, alpha:").concat(a, "))");
};
/**
